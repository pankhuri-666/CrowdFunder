  ...
  return (
    <HomeWrapper suppressHydrationWarning>
      ...
      <FilterWrapper>
        ...
        <Category onClick={() => setFilter(OtherData)}>Other</Category>
      </FilterWrapper>
...
export async function getStaticProps() {
  ...
  const getOtherCampaigns = contract.filters.campaignCreated(null,null,null,null,null,null,'Other');
  const OtherCampaigns = await contract.queryFilter(getOtherCampaigns);
  const OtherData = OtherCampaigns.map((e) => {
    return {
      title: e.args.title,
      image: e.args.imgURI,
      owner: e.args.owner,
